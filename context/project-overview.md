...
Dev AI is a real-time collaborative system design workspace. Users describe a system in plain English, an AI agent maps that system onto a shared canvas, collaborators refine the architectuer, and the app genrates a technical specification from the resulting graph.


## Goals

1. Let authenticated users create and manage architectyre projects.
...
4. Let AI genrate an intial architecture from a natural language prompt.
...
- A Curated library of a prebuilt system design templates.
...
- Convers common patterns: monolith, microservices, event-driven, serverless, and more.
...
- Starter sytem design template library and import
- Real-time shared canvas with nodes. edges and presence
- AI-powered architrure generation from prompts
...
- Versioned spec history and reivew workflows
...
4. AI can generate and architecure into the shared room from a prompt.
