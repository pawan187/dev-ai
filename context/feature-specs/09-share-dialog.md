...
- copy the project link with temporary `Copies!` feedback
...
Collaborators are stored by email in the databse.

Use cleark Backend API to enrich collaborator emails with:
